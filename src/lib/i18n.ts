...
const t = {
  es: {
    ...
    conv_kpi_sessions: 'Conversaciones',
    conv_kpi_avg_depth: 'Profundidad Media',
    conv_kpi_turns: 'turnos',
    conv_kpi_engagement: 'Completaron T5',
    conv_kpi_deep: 'Sesiones Profundas',
    conv_kpi_deep_sub: 'superaron turno 9',
    conv_funnel_title: 'Embudo de Conversación',
    conv_funnel_sub: 'Porcentaje de sesiones que alcanzan cada turno',
    conv_funnel_x: 'Turno',
    conv_funnel_y: '% Sesiones',
    conv_depth_title: 'Profundidad por Ejercicio',
    conv_depth_sub: 'Distribución de turnos por simulador',
    conv_depth_avg: 'Prom.',
    conv_depth_range: 'Rango',
    conv_depth_sessions: 'Sesiones',
    conv_drop_label: 'Caída principal',
    conv_col_exercise: 'Ejercicio',
    conv_col_sessions: 'Sesiones',
    conv_col_avg_turns: 'Turnos Prom.',
    conv_col_depth: 'Profundidad',
    conv_col_completion: '% Completado',

    // Simulations page — sort & filter
    sim_filter_all: 'Todos',
    sim_filter_pass: 'Aprobados',
    sim_filter_fail: 'Reprobados',
    sim_filter_incomplete: 'Incompletos',
    sim_sort_asc: 'Ascendente',
    sim_sort_desc: 'Descendente',
    ...
    cert_certified_def: 'Certificado = ≥70% en cada ejercicio asignado de su producto durante el período.',
  ...
  en: {
    ...
    // Conversation analytics
    conv_kpi_sessions: 'Conversations',
    conv_kpi_avg_depth: 'Avg Depth',
    conv_kpi_turns: 'turns',
    conv_kpi_engagement: 'Reached Turn 5',
    conv_kpi_deep: 'Deep Sessions',
    conv_kpi_deep_sub: 'passed turn 9',
    conv_funnel_title: 'Conversation Funnel',
    conv_funnel_sub: 'Percentage of sessions reaching each turn',
    conv_funnel_x: 'Turn',
    conv_funnel_y: '% Sessions',
    conv_depth_title: 'Depth by Exercise',
    conv_depth_sub: 'Turn distribution per simulator',
    conv_depth_avg: 'Avg',
    conv_depth_range: 'Range',
    conv_depth_sessions: 'Sessions',
    conv_drop_label: 'Main drop-off',
    conv_col_exercise: 'Exercise',
    conv_col_sessions: 'Sessions',
    conv_col_avg_turns: 'Avg Turns',
    conv_col_depth: 'Depth',
    conv_col_completion: '% Completed',

    // Simulations page — sort & filter
    sim_filter_all: 'All',
    sim_filter_pass: 'Passed',
    sim_filter_fail: 'Failed',
    sim_filter_incomplete: 'Incomplete',
    sim_sort_asc: 'Ascending',
    sim_sort_desc: 'Descending',
    ...
    cert_certified_def: 'Certified = above 70% on each of their 3 assigned simulators during the period.',
